...
Slides: [https://github.com/tugbabozcaga](https://github.com/tugbabozcaga).
...
-  Name it **My-First-Depository** and check "Initialize this repository with a README" (Not required but usually a good idea). Find the location of the new repository folder in your computer.
...
- Go back to your file and make additional changes. **Commit** your changes. (You can edit and commit as often as you like, GitHub Desktop will memorize all the changes you committed but they won't appear online until you **Push**.)
